        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <hr>
                    <img class="shadow" style="width: 200px; height: 200px; display: block; margin: auto; border-radius: 50%; border: 10px; solid #FFF; " src="assets/media/img/pp_photo/MG_1216.jpg" alt="">

                    <h2 class="text-center">Muhsina Akter</h2>
